function [testLabels] = kernel_regression_dist(K, trainPoints, trainLabels, testPoints, distFunc)
%KNN_TEST - Evaluates kernel regression/classification predictions given training data and parameters.
% 
%  [testLabels] = kernreg_test(K, trainPoints, trainLabels, testPoints, ...
%                          [distFunc])
%
%   K - Kernel width parameter
