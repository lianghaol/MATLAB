...
%     c_hat = [10000 100 1 1 10]
    ...
    model1 = svmtrain(trainy, trainx, char(strcat('-t 2 -g 0.01 -c',{' '}, int2str(c_hat(1)))));
%     decision_boundary_SVM(trainx, trainy, model1, 200, 'kernel_model1_boundary')
    ...
    model2 = svmtrain(trainy, trainx, char(strcat('-t 2 -g 1 -c',{' '}, int2str(c_hat(2)))));
%     decision_boundary_SVM(trainx, trainy, model2, 200, 'kernel_model2_boundary')
    ...
    model3 = svmtrain(trainy, trainx, char(strcat('-t 2 -g 10 -c',{' '}, int2str(c_hat(3)))));
%     decision_boundary_SVM(trainx, trainy, model3, 200, 'kernel_model3_boundary')
    ...
    model4 = svmtrain(trainy, trainx, char(strcat('-t 2 -g 100 -c',{' '}, int2str(c_hat(4)))));
%     decision_boundary_SVM(trainx, trainy, model4, 200, 'kernel_model4_boundary')
    ...
    model5 = svmtrain(trainy, trainx, char(strcat('-t 2 -g 1000 -c',{' '}, int2str(c_hat(5)))));
%     decision_boundary_SVM(trainx, trainy, model5, 200, 'kernel_model5_boundary')
...
%   Plot Train-Test Errors over sigma
    ...
    logsigma = [-2 0 1 2 3];
    PlotErrors_Kernel(train_err, test_err, val_err_hat, logsigma, 'Kernel_Val_Errs');
